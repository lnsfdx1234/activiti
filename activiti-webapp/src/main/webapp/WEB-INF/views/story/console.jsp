...
<body>
	<h1>Log4j控制頁面</h1>
	<h2>管理基本级别</h2>
	<form:form id="defaultLoggerForm" action="${ctx}/story/defaultsetting" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="projectLoggerLevel" items="${levels}" class="span2"/> 不知道日志怎么写着一基本级别
			</div>
		</div>		 
	...
	<h2>管理任意Logger级别</h2>
	<form:form id="anyLoggerForm" action="${ctx}/story/loggersetting" method="post" class="form-horizontal">
		<div class="control-group">
